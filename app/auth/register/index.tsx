...
const RegisterScreen = () => {
    ...
    const onSignUp = async () => {
        ...
        if (username.length < 2) {
            Alert.alert('Validation', 'Username must be at least 2 characters.');
            return;
        }

        setIsPosting(true);
        const wasSuccessful = await signUp(email, password, username);
        setIsPosting(false);
                ...
                >
                    ...
                    <View className='mb-8'>
                        ...
                        <Text className='text-white/50 text-base text-center'>
                            Join CritiCast and start reviewing
                        </Text>
                    </View>
